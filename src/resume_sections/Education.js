  ...
  render (){
    return(
      <section>
        ...
        <p>In May 2023, I graduated from Harvard with a Bachelor of Arts cum laude in Computer Science with a secondary in Economics. Here are some of the more relevant classes:
        <ul>
          ...
          <li><b>Statistics:</b>
            <ul>
              ...
              <li>STAT 91R: Independent Research on Soccer Data Analytics</li>
            </ul>
          </li>
          <li><b>Mathematics:</b>
            <ul>
