  ...
  return (
      ...
      <main >
        <nav className="section-nav">
          <ol>
              <li><a href="#work" className={getCurrent() === "work" ? "nav-item-visible" : "nav-item-hidden"}>Work</a></li>
              <li><a href="#education" className={getCurrent() === "education" ? "nav-item-visible" : "nav-item-hidden"}>Education</a></li>
              <li><a href="#acts" className={getCurrent() === "fun" ? "nav-item-visible" : "nav-item-hidden"}>Fun</a></li>
          </ol>
        </nav>
