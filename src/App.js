    ...
    return (
      <div>
        <Navbar
          ...
          fixed="top"
        >
          <Navbar.Brand onClick={(e) => this.switchPage(e, "home")} href="#">
            Connor Leggett
          </Navbar.Brand>
          <Navbar.Toggle aria-controls="basic-navbar-nav" />
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="mr-auto">
              <Nav.Link onClick={(e) => this.switchPage(e, "resume")}>
                About Me
              </Nav.Link>
              <Nav.Link onClick={(e) => this.switchPage(e, "contact")}>
                Contact
              </Nav.Link>
            </Nav>
          </Navbar.Collapse>
        ...
        >
          ...
          <Nav className="mr-auto">
            ...
            <Nav.Link
              onClick={(e) =>
                this.externalLink(e, "https://github.com/cjleggett")
              }
              href="#"
            >
              GitHub
            ...
            <Nav.Link
              onClick={(e) =>
                this.externalLink(
                  e,
                  "https://www.linkedin.com/in/connor-leggett",
                )
              }
              href="#"
            >
